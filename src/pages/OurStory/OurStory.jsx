...
const OurStory = () => {
    return (
        <div>
                    ...
                    <ScrollReveal>
                        <div className='py-16 max-w-[1440px] mx-auto'>
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mt-12">
                                <div className="group relative p-10 bg-white rounded-3xl shadow-sm border border-gray-100 hover:border-primary/20 transition-all duration-500 overflow-hidden">
                                    <div className="absolute -top-10 -right-10 w-32 h-32 bg-purple-50 rounded-full group-hover:scale-150 transition-transform duration-700 ease-in-out opacity-50">
                                    </div>
                                    ...
                                    <div className="relative z-10">
                                        <div className="w-14 h-14 bg-primary/10 rounded-2xl flex items-center justify-center mb-6 group-hover:bg-primary group-hover:text-white transition-colors duration-300">
                                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-8 h-8">
                                                <path strokeLinecap="round" strokeLinejoin="round" d="M15.59 14.37a6 6 0 0 1-5.84 7.38v-4.8m5.84-2.58a14.98 14.98 0 0 0 6.16-12.12A14.98 14.98 0 0 0 9.63 3.18a14.98 14.98 0 0 0-6.16 12.12c0 2.22.48 4.33 1.34 6.24" />
                                            </svg>
                                        </div>

                                        <h4 className="text-3xl font-black text-gray-800 mb-4 tracking-tight">Our Mission</h4>
                                        <div className="w-12 h-1 bg-primary mb-6 group-hover:w-24 transition-all duration-500"></div>

                                        <p className="text-gray-500 text-lg leading-relaxed font-light">
                                            To redefine casual fashion by <span className="text-gray-800 font-medium">blending tradition with modern trends</span>.
                                            We craft premium apparel that makes luxury accessible, ensuring every stitch tells a story of comfort and durability.
                                        </p>
                                    </div>
                                </div>

                                <div className="group relative p-10 bg-[#3b1e5a] rounded-3xl shadow-xl hover:shadow-2xl transition-all duration-500 overflow-hidden">
                                    <div className="absolute -bottom-10 -left-10 w-32 h-32 bg-white/5 rounded-full group-hover:scale-150 transition-transform duration-700 ease-in-out"></div>

                                    <div className="relative z-10">
                                        <div className="w-14 h-14 bg-white/10 rounded-2xl flex items-center justify-center mb-6 group-hover:bg-cyan-400 group-hover:text-white transition-colors duration-300 text-cyan-400">
                                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-8 h-8">
                                        ...
                                        <h4 className="text-3xl font-black text-white mb-4 tracking-tight">Our Vision</h4>
                                        <div className="w-12 h-1 bg-cyan-400 mb-6 group-hover:w-24 transition-all duration-500"></div>

                                        <p className="text-purple-100/80 text-lg leading-relaxed font-light">
                                            To establish <span className="text-white font-medium">Taati</span> as a global benchmark for Bangladeshi excellence.
                                            We envision a future where our commitment to craftsmanship inspires style-conscious individuals across the world.
                                        </p>
                                    </div>
                                </div>
                            </div>
            ...
            <div class="pt-2 pb-8 mx-auto text-center">
                <StatsSection></StatsSection>
                <h3 class="text-2xl font-bold text-[#3b1e5a] mt-12 mb-6">Ready to upgrade your wardrobe?</h3>
